...
- [ ] T081 Rodar os 14 cenários de [quickstart.md](./quickstart.md) — **10 de 14.** O cenário 3 foi **medido** em vez de olhado, comparando pixel a pixel o shader contra a cadeia de produção — e achou uma divergência real de croma, corrigida e re-medida (quickstart.md e docs/technical-debt/preview-export-parity-combined.md). Os 4 restantes (1, 2, 13, 14) exigem o diálogo nativo ou a janela do Electron
