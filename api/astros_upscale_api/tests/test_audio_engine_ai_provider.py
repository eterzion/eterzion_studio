...
class TestIsAvailable:
    ...
    def test_true_when_files_present_and_gpu_has_enough_vram(self, monkeypatch, tmp_path):
        """FR-017 — reuses astros_upscale.processing.detect_hardware() (Princípio
        ...
        here (real hardware detection is already covered by astros_upscale's
        ...
        import astros_upscale.processing as processing_module
