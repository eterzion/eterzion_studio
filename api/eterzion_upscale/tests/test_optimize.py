...
from eterzion_upscale.optimize import (EncoderUnavailableError, UnsupportedFormatError,
...
from eterzion_upscale.media import GPL_ENCODERS, imwrite
...
def test_every_video_extension_has_an_encoder_list():
    ...
    from eterzion_upscale.optimize import VIDEO_EXTENSIONS
...
def test_optimize_video_refuses_before_transcoding_when_nothing_works(tmp_path, monkeypatch):
    ...
    from eterzion_upscale import optimize as optimize_module
